...
async function main() {
  ...
  const news = [
    ...
    {
      slug: 'tower-chronicle-starter-kit',
      titleEn: 'Tower Chronicle Starter Kit',
      titleTh: 'Tower Chronicle Starter Kit',
      excerptEn: 'How the team maps launch-week reads, checklists, and webzine drops.',
      excerptTh: 'How the team maps launch-week reads, checklists, and webzine drops.',
      contentEn: '<p>We built the Chronicle to guide new players from onboarding to patch notes, class tips, and live event updates without losing momentum.</p>',
      contentTh: '<p>We built the Chronicle to guide new players from onboarding to patch notes, class tips, and live event updates without losing momentum.</p>',
      category: 'UPDATE' as const,
      contentType: 'DEV_BLOG' as const,
      primaryTopicKey: 'getting-started',
      status: 'PUBLISHED' as const,
      featuredImage: '/images/news-2.png',
    ...
    {
      slug: 'skyward-pact-lore-primer',
      titleEn: 'Skyward Pact Lore Primer',
      titleTh: 'Skyward Pact Lore Primer',
      excerptEn: 'Meet the factions guarding the first ascent through the Eternal Tower.',
      excerptTh: 'Meet the factions guarding the first ascent through the Eternal Tower.',
      contentEn: '<p>The Skyward Pact unites scouts, archivists, and mercenary captains who keep the first tower routes open for new climbers.</p>',
      contentTh: '<p>The Skyward Pact unites scouts, archivists, and mercenary captains who keep the first tower routes open for new climbers.</p>',
      category: 'UPDATE' as const,
      contentType: 'LORE' as const,
      primaryTopicKey: 'world-lore',
      status: 'PUBLISHED' as const,
      featuredImage: '/images/news-1.png',
  ...
  await prisma.gameEvent.upsert({
    where: { id: 'seed-skybreaker-rally' },
    update: {
      titleEn: 'Skybreaker Rally',
      titleTh: 'Skybreaker Rally',
      descriptionEn: 'A launch-week sprint event that rewards parties for clearing marked rally routes together.',
      descriptionTh: 'A launch-week sprint event that rewards parties for clearing marked rally routes together.',
      type: 'EVENT',
      status: 'SCHEDULED',
      startsAt: new Date('2026-04-29T12:00:00.000Z'),
      endsAt: new Date('2026-05-02T12:00:00.000Z'),
      timezone: 'Asia/Bangkok',
      campaignCode: 'skybreaker-rally',
      bannerImage: '/images/news-2.png',
      icon: 'i-lucide-flag',
      color: '#d4a843',
      visible: true,
    },
    create: {
      id: 'seed-skybreaker-rally',
      titleEn: 'Skybreaker Rally',
      titleTh: 'Skybreaker Rally',
      descriptionEn: 'A launch-week sprint event that rewards parties for clearing marked rally routes together.',
      descriptionTh: 'A launch-week sprint event that rewards parties for clearing marked rally routes together.',
  ...
  console.log('  âœ… Skybreaker Rally event seeded')

  const [seasonZeroPatchNotes, towerChronicleStarterKit, skybreakerRally] = await Promise.all([
    prisma.newsArticle.findUnique({ where: { slug: 'season-zero-patch-notes' } }),
    prisma.newsArticle.findUnique({ where: { slug: 'tower-chronicle-starter-kit' } }),
    prisma.gameEvent.findUnique({ where: { id: 'seed-skybreaker-rally' } }),
  ])

  const bannerSeeds = [
    towerChronicleStarterKit && {
      id: 'seed-homepage-inline',
      placement: 'homepage_inline' as const,
      status: 'LIVE' as const,
      scope: 'homepage' as const,
      priority: 90,
      campaignCode: 'chronicle-launch',
      badgeEn: 'Editor Pick',
      badgeTh: 'Editor Pick',
      titleEn: 'Tower Chronicle Starter Kit',
      titleTh: 'Tower Chronicle Starter Kit',
      bodyEn: 'See how the Chronicle is organized before you dive into launch-week reads.',
      bodyTh: 'See how the Chronicle is organized before you dive into launch-week reads.',
      targetType: 'article' as const,
      targetArticleId: towerChronicleStarterKit.id,
      targetNewTab: false,
      dismissible: true,
      isActive: true,
      config: {},
    ...
    skybreakerRally && {
      id: 'seed-homepage-popup',
      placement: 'popup' as const,
      status: 'LIVE' as const,
      scope: 'homepage' as const,
      priority: 95,
      campaignCode: 'founder-cache',
      badgeEn: 'Founder Cache',
      badgeTh: 'Founder Cache',
      titleEn: 'Claim Your Founder Cache',
      titleTh: 'Claim Your Founder Cache',
      bodyEn: 'Jump into the event page to lock launch rewards before Skybreaker Rally opens.',
      bodyTh: 'Jump into the event page to lock launch rewards before Skybreaker Rally opens.',
      targetType: 'event' as const,
      targetEventId: skybreakerRally.id,
      targetNewTab: false,
      dismissible: true,
      isActive: true,
      config: { delaySeconds: 3, frequency: 'session', mobileEnabled: true },
    },
    beginnerGuide && {
      id: 'seed-homepage-floating',
      placement: 'floating' as const,
      status: 'LIVE' as const,
      scope: 'homepage' as const,
      priority: 80,
      campaignCode: 'guide-fast-start',
      badgeEn: 'Fast Start',
      badgeTh: 'Fast Start',
      titleEn: 'Need a fast start?',
      titleTh: 'Need a fast start?',
      bodyEn: 'Open the beginner guide for the shortest route from tutorial to launch rewards.',
      bodyTh: 'Open the beginner guide for the shortest route from tutorial to launch rewards.',
      targetType: 'article' as const,
      targetArticleId: beginnerGuide.id,
      targetNewTab: false,
      dismissible: true,
      isActive: true,
      config: { corner: 'bottom_right', compact: false },
    },
    seasonZeroPatchNotes && {
      id: 'seed-global-footer-strip',
      ...
      titleEn: 'Season Zero Patch Notes',
      titleTh: 'Season Zero Patch Notes',
      bodyEn: 'Catch every launch-week balance change and polish pass in one scroll.',
      bodyTh: 'Catch every launch-week balance change and polish pass in one scroll.',
      targetType: 'article' as const,
      targetArticleId: seasonZeroPatchNotes.id,
      targetNewTab: false,
      dismissible: true,
      isActive: true,
      config: {},
    ...
    beginnerGuide && {
      id: 'seed-news-sidebar',
      placement: 'sidebar' as const,
      status: 'LIVE' as const,
      scope: 'news_index' as const,
      priority: 85,
      campaignCode: 'chronicle-sidebar',
      badgeEn: 'Quick Route',
      badgeTh: 'Quick Route',
      titleEn: 'Tower Tactics Index',
      titleTh: 'Tower Tactics Index',
      bodyEn: 'Bookmark the beginner route, class deep dive, and launch-week checklist.',
      bodyTh: 'Bookmark the beginner route, class deep dive, and launch-week checklist.',
      targetType: 'article' as const,
      targetArticleId: beginnerGuide.id,
      targetNewTab: false,
      dismissible: true,
    ...
    beginnerGuide && {
      id: 'seed-article-inline',
      placement: 'article_inline' as const,
      status: 'LIVE' as const,
      scope: 'specific_article' as const,
      priority: 90,
      campaignCode: 'launch-week',
      badgeEn: 'Checklist',
      badgeTh: 'Checklist',
      titleEn: 'Decode The Launch Week Checklist',
      titleTh: 'Decode The Launch Week Checklist',
      bodyEn: 'Use this inline reminder to keep rewards, event windows, and class setup in one pass.',
      bodyTh: 'Use this inline reminder to keep rewards, event windows, and class setup in one pass.',
      targetType: 'article' as const,
      targetArticleId: beginnerGuide.id,
      targetNewTab: false,
      dismissible: true,
      isActive: true,
      config: { insertAfterParagraph: 2 },
    },
    skybreakerRally && {
      id: 'seed-event-popup',
      placement: 'popup' as const,
      ...
      priority: 110,
      campaignCode: 'event-launch',
      badgeEn: 'Launch Window',
      badgeTh: 'Launch Window',
      titleEn: 'Pre-Register Before Launch',
      titleTh: 'Pre-Register Before Launch',
      bodyEn: 'Lock in launch rewards now and keep the Skybreaker Rally calendar on your radar.',
      bodyTh: 'Lock in launch rewards now and keep the Skybreaker Rally calendar on your radar.',
      targetType: 'event' as const,
      targetEventId: skybreakerRally.id,
      targetNewTab: false,
      dismissible: true,
    ...
    skybreakerRally && {
      id: 'seed-event-floating',
      placement: 'floating' as const,
      status: 'LIVE' as const,
      scope: 'event_page' as const,
      priority: 95,
      campaignCode: 'referral-push',
      badgeEn: 'Referral Boost',
      badgeTh: 'Referral Boost',
      titleEn: 'Invite Squadmates, Stack Rewards',
      titleTh: 'Invite Squadmates, Stack Rewards',
      bodyEn: 'Referral bonuses and community milestones both climb faster when your party registers together.',
      bodyTh: 'Referral bonuses and community milestones both climb faster when your party registers together.',
      targetType: 'event' as const,
      targetEventId: skybreakerRally.id,
      targetNewTab: false,
      dismissible: true,
    ...
    skybreakerRally && {
      id: 'seed-event-footer-strip',
      placement: 'footer_strip' as const,
      status: 'LIVE' as const,
      scope: 'event_page' as const,
      priority: 95,
      campaignCode: 'milestone-rewards',
      badgeEn: 'Reward Map',
      badgeTh: 'Reward Map',
      titleEn: 'Launch rewards overview',
      titleTh: 'Launch rewards overview',
      bodyEn: 'Review every pre-registration reward and the next milestone before launch day hits.',
      bodyTh: 'Review every pre-registration reward and the next milestone before launch day hits.',
      targetType: 'event' as const,
      targetEventId: skybreakerRally.id,
      targetNewTab: false,
      dismissible: true,
  ...
  console.log(`  âœ… ${bannerSeeds.length} marketing banners seeded`)
