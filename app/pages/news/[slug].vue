  ...
  <div>
    <section class="mx-auto max-w-[800px] px-6 pt-24">
      ...
      <article v-if="article">
        ...
        <div class="prose prose-invert max-w-none text-white/60 [&_h2]:mb-4 [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:text-white [&_p]:mb-6 [&_p]:leading-[1.8]" v-html="renderedHtml" />
      </article>
