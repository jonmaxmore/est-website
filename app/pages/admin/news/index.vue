<template>
  <div>
    ...
    <div class="mb-4 flex flex-wrap gap-3 rounded-2xl border border-white/6 bg-white/4 p-4">
      ...
      <USelect v-model="filters.status" :items="[{ label: 'All Status', value: '' }, { label: 'Draft', value: 'DRAFT' }, { label: 'Published', value: 'PUBLISHED' }, { label: 'Archived', value: 'ARCHIVED' }]" value-key="value" class="w-36" @update:model-value="loadArticles" />
      <USelect v-model="filters.category" :items="[{ label: 'All Categories', value: '' }, { label: 'Announcement', value: 'ANNOUNCEMENT' }, { label: 'Event', value: 'EVENT' }, { label: 'Update', value: 'UPDATE' }, { label: 'Media', value: 'MEDIA' }]" value-key="value" class="w-40" @update:model-value="loadArticles" />
