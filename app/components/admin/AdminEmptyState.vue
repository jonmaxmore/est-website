...
.aes-btn {
  ...
  background: linear-gradient(135deg, var(--adm-gold), var(--adm-gold-deep)); color: black;
  font-size: 0.8125rem; font-weight: 700; cursor: pointer; transition: filter 0.15s;
}
